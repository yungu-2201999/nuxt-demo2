import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, h, computed, unref, ref, Suspense, nextTick, mergeProps, provide, watch, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { i as createHooks, j as getContext, e as createError$1, t as toRouteMatcher, k as createRouter, s as sanitizeStatusCode, l as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_hgpAo8HXOp75Der3jTDdkiJzKDGZtR64gay7wFf2AU0 = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
async function createClientPage(loader) {
  _createClientPage || (_createClientPage = await import('./client-component.mjs').then((r) => r.createClientPage));
...
const _routes = [
  ...
  },
  {
    name: "posts-id",
    path: "/posts/:id()",
    component: () => createClientPage(() => import('./_id_.client.vue.mjs'))
  }
];
...
const revive_payload_server_W7PoT75QiMo6o51kyx0CqqnlNMrn1pQsGH_06QlzAr8 = defineNuxtPlugin({
...
const plugin_EOQH7ZYQ4n7a6I4GYDaRNfCO4AtrSWk9m38hwk6WZ40 = defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
    var _a, _b;
...
const prerender_server_7je2TCQsW4Vkk7A5stXWVqz7weiWLqlynfUtmuUOgnI = defineNuxtPlugin(async () => {
  {
    return;
  }
});
...
const plugins = [
  unhead_hgpAo8HXOp75Der3jTDdkiJzKDGZtR64gay7wFf2AU0,
  plugin,
  revive_payload_server_W7PoT75QiMo6o51kyx0CqqnlNMrn1pQsGH_06QlzAr8,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  plugin_EOQH7ZYQ4n7a6I4GYDaRNfCO4AtrSWk9m38hwk6WZ40,
  prerender_server_7je2TCQsW4Vkk7A5stXWVqz7weiWLqlynfUtmuUOgnI
];
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_better-sqlite3@11.9.1_db0@0.3.1_better-sqlite3@11.9.1__esli_5xg2dlcrf3gb6essjfjjb5ouuq/node_modules/nuxt/dist/pages/runtime/app.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_better-sqlite3@11.9.1_db0@0.3.1_better-sqlite3@11.9.1__esli_5xg2dlcrf3gb6essjfjjb5ouuq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_better-sqlite3@11.9.1_db0@0.3.1_better-sqlite3@11.9.1__esli_5xg2dlcrf3gb6essjfjjb5ouuq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, _export_sfc as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, nuxtLinkDefaults as e, defu as f, withLeadingSlash as g, hasProtocol as h, parseURL as i, joinURL as j, encodePath as k, encodeParam as l, useAppConfig as m, navigateTo as n, getIcon as o, parseQuery as p, loadIcon as q, resolveRouteObject as r, asyncDataDefaults as s, tryUseNuxtApp as t, useRoute as u, createError as v, withTrailingSlash as w, server as x };
